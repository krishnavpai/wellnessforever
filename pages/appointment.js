...
<htmlForm>
    <div className="grid gap-6 mb-6 md:grid-cols-2 pt-20">
        <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 light:text-white">First name</label>
        ...
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Last name</label>
        ...
        <div>
            <label htmlFor="website" className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Doctor name</label>
    ...
    <div className="mb-6">
        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Email address</label>
    ...
    <div className="flex items-start mb-6">
        ...
        <label htmlFor="remember" className="ml-2 text-sm font-medium text-gray-900 light:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline light:text-blue-500">terms and conditions</a>.</label>
    </div>
